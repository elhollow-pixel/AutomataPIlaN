...
class ventana(Tk):
    ...
    def __initUi(self):
        ...
        #Añadiendo botones
        self.botonL = Button(self.frame, bg='lightgray', text='Lento', justify=CENTER, width=20, relief="raised",bd=4, command=lambda: self.__iniciar(self.speedS, self.automataPila))
        self.botonL.place(x=30, y=500)
        self.botonR = Button(self.frame, bg='lightgray',text='Rapido', justify=CENTER, width=20, relief="raised",bd=4, command=lambda: self.__iniciar(self.speedF, self.automataPila))
        self.botonR.place(x=200, y=500) 
        self.botonA = Button(self.frame, text='Ayuda',justify=CENTER, width=10, relief="raised", bg='gray', highlightcolor='lightgray', highlightbackground='lightgray', activebackground='white', bd=5)
        self.botonA.place(x=10, y=10)
#---------------------------------
        self.botonE = Button(self.frame, bd=4, text='Escuchar',width=10,relief="raised", bg='gray',command=self.escuchar)
